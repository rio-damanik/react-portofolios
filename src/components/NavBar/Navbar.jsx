        ...
        <nav className="navbar">
          ...
          <div className="navbar-menu">
            <ul>
              ...
              <li>
                <a href="https://drive.google.com/file/d/1q32_xL-k6DIxR5kGrBqHuOhmttalODFD/view?usp=sharing" className={`hire-me-btn ${isHireMeActive ? "active-hire-me" : ""}`} onClick={handleHireMeClick}>
                  Hire Me
                </a>
              </li>
            </ul>
